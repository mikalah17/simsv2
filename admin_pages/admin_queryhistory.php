...
$historyStmt = $pdo->query('SELECT query_id, user_id, queryDesc, queryTime FROM query ORDER BY queryTime DESC');
$queryHistory = $historyStmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="content-wrapper">
            <div class="history-panel">
                <div class="history-header">
                    ...
                    <a href="admin_query.php" class="back-btn">Back to Query Analyzer</a>
                </div>
                            ...
                            <div class="history-item">
                                <div class="history-meta">
                                    <div class="history-info">
                                        ...
                                        <div class="history-datetime"><?php echo htmlspecialchars(date('F d, Y - g:i A', strtotime($entry['queryTime']))); ?></div>
                                    </div>
                                    <a href="admin_query.php?requery=<?php echo $entry['query_id']; ?>" class="requery-btn">Re-query</a>
                                </div>
                                <div class="history-query"><?php echo htmlspecialchars($entry['queryDesc']); ?></div>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <div class="no-history">No queries in history yet. Go to Query Analyzer to execute a query.</div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
